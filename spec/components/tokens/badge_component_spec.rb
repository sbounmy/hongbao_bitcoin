  ...
  describe "#render" do
    context "when user has tokens" do
      it "shows positive balance" do
        ...
        expect(page).to have_css(".indicator-item.badge", text: "490")
      end
    end
    ...
    context "when user has no tokens" do
      it "shows zero" do
        ...
        expect(page).to have_css(".indicator-item.badge", text: "0")
      end
    end
    ...
    context "when user has negative balance" do
      it "shows negative" do
        ...
        expect(page).to have_css(".indicator-item.badge", text: "-30")
      end
    end
  end
end
